...
NRD_CONSTANTS_END
    ...
    NRD_INPUT_TEXTURE_START
        ...
        NRD_INPUT_TEXTURE( Texture2D<float>, gIn_Diff, t, 6 )
        NRD_INPUT_TEXTURE( Texture2D<float>, gIn_History_Diff, t, 7 )
        NRD_INPUT_TEXTURE( Texture2D<float>, gIn_Spec, t, 8 )
        NRD_INPUT_TEXTURE( Texture2D<float>, gIn_History_Spec, t, 9 )
    ...
    NRD_INPUT_TEXTURE_START
        ...
        NRD_INPUT_TEXTURE( Texture2D<uint>, gIn_Prev_ViewZ_DiffAccumSpeed, t, 3 )
        NRD_INPUT_TEXTURE( Texture2D<uint>, gIn_Prev_Normal_SpecAccumSpeed, t, 4 )
        NRD_INPUT_TEXTURE( Texture2D<float>, gIn_Diff, t, 5 )
        NRD_INPUT_TEXTURE( Texture2D<float>, gIn_History_Diff, t, 6 )
        #if( defined REBLUR_PROVIDED_CONFIDENCE )
