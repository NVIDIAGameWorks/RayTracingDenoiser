...
NRD_SAMPLERS_END
    ...
    NRD_INPUTS_START
        ...
        NRD_INPUT( Texture2D<float>, gIn_Prev_ViewZ, t, 4 )
        NRD_INPUT( Texture2D<float4>, gIn_Prev_Normal_Roughness, t, 5 )
        NRD_INPUT( Texture2D<uint>, gIn_Prev_InternalData, t, 6 )
        NRD_INPUT( Texture2D<float>, gIn_DisocclusionThresholdMix, t, 7 )
        NRD_INPUT( Texture2D<float>, gIn_Diff_Confidence, t, 8 )
        NRD_INPUT( Texture2D<float>, gIn_Spec_Confidence, t, 9 )
        NRD_INPUT( Texture2D<REBLUR_TYPE>, gIn_Diff, t, 10 )
        NRD_INPUT( Texture2D<REBLUR_TYPE>, gIn_Spec, t, 11 )
        NRD_INPUT( Texture2D<REBLUR_TYPE>, gIn_Diff_History, t, 12 )
        NRD_INPUT( Texture2D<REBLUR_TYPE>, gIn_Spec_History, t, 13 )
        NRD_INPUT( Texture2D<REBLUR_FAST_TYPE>, gIn_DiffFast_History, t, 14 )
        NRD_INPUT( Texture2D<REBLUR_FAST_TYPE>, gIn_SpecFast_History, t, 15 )
        NRD_INPUT( Texture2D<float>, gIn_Prev_Spec_HitDistForTracking, t, 16 )
        #ifndef REBLUR_OCCLUSION
            NRD_INPUT( Texture2D<float>, gIn_Spec_HitDistForTracking, t, 17 )
        #endif
        #ifdef REBLUR_SH
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_DiffSh, t, 18 )
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_SpecSh, t, 19 )
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_DiffSh_History, t, 20 )
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_SpecSh_History, t, 21 )
        #endif
    NRD_INPUTS_END
    ...
    NRD_INPUTS_START
        ...
        NRD_INPUT( Texture2D<REBLUR_TYPE>, gIn_Diff_History, t, 10 )
        NRD_INPUT( Texture2D<REBLUR_FAST_TYPE>, gIn_DiffFast_History, t, 11 )
        #ifdef REBLUR_SH
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_DiffSh, t, 12 )
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_DiffSh_History, t, 13 )
        #endif
    NRD_INPUTS_END
    ...
    NRD_INPUTS_START
        ...
        NRD_INPUT( Texture2D<uint>, gIn_Prev_InternalData, t, 6 )
        NRD_INPUT( Texture2D<float>, gIn_DisocclusionThresholdMix, t, 7 )
        NRD_INPUT( Texture2D<float>, gIn_Spec_Confidence, t, 8 )
        NRD_INPUT( Texture2D<REBLUR_TYPE>, gIn_Spec, t, 9 )
        NRD_INPUT( Texture2D<REBLUR_TYPE>, gIn_Spec_History, t, 10 )
        NRD_INPUT( Texture2D<REBLUR_FAST_TYPE>, gIn_SpecFast_History, t, 11 )
        NRD_INPUT( Texture2D<float>, gIn_Prev_Spec_HitDistForTracking, t, 12 )
        #ifndef REBLUR_OCCLUSION
            NRD_INPUT( Texture2D<float>, gIn_Spec_HitDistForTracking, t, 13 )
        #endif
        #ifdef REBLUR_SH
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_SpecSh, t, 14 )
            NRD_INPUT( Texture2D<REBLUR_SH_TYPE>, gIn_SpecSh_History, t, 15 )
        #endif
    NRD_INPUTS_END
