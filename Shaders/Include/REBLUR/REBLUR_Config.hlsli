...
#define REBLUR_USE_LOADS                                        0 // replaced "SampleLevel"s with "Load"s in spatial filtering
...
// Texture access
    ...
    #define REBLUR_SAMPLE_TEXTURE( tex, uv )                    tex[ uv ## i ]
#else
    #define REBLUR_SAMPLE_TEXTURE( tex, uv )                    tex.SampleLevel( gNearestClamp, uv, 0 )
#endif
