...
*/
    ...
    groupshared float4 sharedSpecularResponsiveYCoCg[GROUP_Y + BORDER * 2][GROUP_X + BORDER * 2];
    groupshared float4 sharedSpecularNoisyAnd2ndMoment[GROUP_Y + BORDER * 2][GROUP_X + BORDER * 2];
#endif

#ifdef RELAX_DIFFUSE
    groupshared float4 sharedDiffuseNoisyAnd2ndMoment[GROUP_Y + BORDER * 2][GROUP_X + BORDER * 2];
    groupshared float4 sharedDiffuseResponsiveYCoCg[GROUP_Y + BORDER * 2][GROUP_X + BORDER * 2];
#endif
