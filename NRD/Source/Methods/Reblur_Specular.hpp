...
size_t DenoiserImpl::AddMethod_ReblurSpecular(uint16_t w, uint16_t h)
{
    ...
    PushPass("REBLUR::Specular - temporal accumulation");
    {
        ...
        AddDispatch( REBLUR_Specular_TemporalAccumulation, SumConstants(4, 1, 1, 4), 8, 1 );
    }
    ...
    PushPass("REBLUR::Specular - history fix");
    {
        ...
        AddDispatch( REBLUR_Specular_HistoryFix, SumConstants(1, 1, 0, 3), 16, 1 );
    }
    ...
    PushPass("REBLUR::Specular - blur");
    {
        ...
        AddDispatch( REBLUR_Specular_Blur, SumConstants(1, 2, 0, 1), 16, 1 );
    }
    ...
    PushPass("REBLUR::Specular - post-blur");
    {
        ...
        AddDispatch( REBLUR_Specular_PostBlur, SumConstants(1, 2, 0, 1), 16, 1 );
    }
