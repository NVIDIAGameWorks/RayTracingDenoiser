...
NRI_RESOURCE( Texture2D<float>, gIn_B, t, 1, 0 );

// Outputs
NRI_RESOURCE( RWTexture2D<float4>, gOut_A_x2, u, 0, 0 );
NRI_RESOURCE( RWTexture2D<float>, gOut_B_x2, u, 1, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_A_x4, u, 2, 0 );
NRI_RESOURCE( RWTexture2D<float>, gOut_B_x4, u, 3, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_A_x8, u, 4, 0 );
NRI_RESOURCE( RWTexture2D<float>, gOut_B_x8, u, 5, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_A_x16, u, 6, 0 );
NRI_RESOURCE( RWTexture2D<float>, gOut_B_x16, u, 7, 0 );
...
void main( uint2 groupID : SV_GroupID, uint threadID : SV_GroupIndex )
{
    ...
    float b00 = gIn_B.Load( coord, int2( 0, 0 ) );
    float b10 = gIn_B.Load( coord, int2( 1, 0 ) );
    float b01 = gIn_B.Load( coord, int2( 0, 1 ) );
    float b11 = gIn_B.Load( coord, int2( 1, 1 ) );
