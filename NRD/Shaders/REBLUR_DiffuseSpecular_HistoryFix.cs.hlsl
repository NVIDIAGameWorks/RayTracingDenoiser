...
NRI_RESOURCE( Texture2D<float4>, gIn_Diff, t, 3, 0 );  // mips 1+, mip = 0 actually samples from mip#1!
NRI_RESOURCE( Texture2D<float4>, gIn_Spec, t, 4, 0 ); // mips 1+, mip = 0 actually samples from mip#1!
NRI_RESOURCE( Texture2D<float4>, gIn_Fast_Diff, t, 5, 0 );
