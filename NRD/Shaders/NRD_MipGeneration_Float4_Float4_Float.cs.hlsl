...
NRI_RESOURCE( RWTexture2D<float>, gOut_ScaledViewZ_x2, u, 2, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_A_x4, u, 3, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_B_x4, u, 4, 0 );
NRI_RESOURCE( RWTexture2D<float>, gOut_ScaledViewZ_x4, u, 5, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_A_x8, u, 6, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_B_x8, u, 7, 0 );
NRI_RESOURCE( RWTexture2D<float>, gOut_ScaledViewZ_x8, u, 8, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_A_x16, u, 9, 0 );
NRI_RESOURCE( RWTexture2D<float4>, gOut_B_x16, u, 10, 0 );
NRI_RESOURCE( RWTexture2D<float>, gOut_ScaledViewZ_x16, u, 11, 0 );
...
[numthreads( 16, 16, 1 )]
void NRD_CS_MAIN( uint2 groupID : SV_GroupID, uint threadID : SV_GroupIndex )
{
