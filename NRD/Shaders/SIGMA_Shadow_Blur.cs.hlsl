...
NRI_RESOURCE( RWTexture2D<SIGMA_TYPE>, gOut_Shadow_Translucency, u, 1, 0 );

#ifdef SIGMA_FIRST_PASS
    NRI_RESOURCE( RWTexture2D<SIGMA_TYPE>, gOut_History, u, 2, 0 );
#endif
...
void NRD_CS_MAIN( int2 threadId : SV_GroupThreadId, int2 pixelPos : SV_DispatchThreadId, uint threadIndex : SV_GroupIndex )
{
    ...
    hitDist = max( hitDist, SIGMA_MIN_DISTANCE );
