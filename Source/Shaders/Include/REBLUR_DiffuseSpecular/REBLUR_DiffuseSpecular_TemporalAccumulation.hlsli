...
#include "NRD.hlsli"
#include "STL.hlsli"
#include "REBLUR_DiffuseSpecular/REBLUR_DiffuseSpecular_TemporalAccumulation.resources.hlsli"
...
void Preload( uint2 sharedPos, int2 globalPos )
{
    ...
    s_Normal[ sharedPos.y ][ sharedPos.x ] = NRD_FrontEnd_UnpackNormalAndRoughness( gIn_Normal_Roughness[ globalIdUser ] ).xyz;
