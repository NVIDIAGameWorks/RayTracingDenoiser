...
#define NRD_DECLARE_OUTPUT_TEXTURES \
    ...
    NRD_OUTPUT_TEXTURE( RWTexture2D<float2>, gOut_A_x4, u, 1 ) \
    NRD_OUTPUT_TEXTURE( RWTexture2D<float2>, gOut_A_x8, u, 2 ) \
    NRD_OUTPUT_TEXTURE( RWTexture2D<float2>, gOut_A_x16, u, 3 )
