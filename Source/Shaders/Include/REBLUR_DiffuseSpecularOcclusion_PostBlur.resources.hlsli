...
#include "REBLUR_Config.hlsli"
    ...
    #define EXTRA_OUTPUTS \
        NRD_OUTPUT_TEXTURE( RWTexture2D<float>, gOut_Diff, u, 2 ) \
        NRD_OUTPUT_TEXTURE( RWTexture2D<float>, gOut_Spec, u, 3 )
    ...
    #define EXTRA_OUTPUTS \
        NRD_OUTPUT_TEXTURE( RWTexture2D<float>, gOut_Spec, u, 2 )
...
#define NRD_DECLARE_OUTPUT_TEXTURES \
    ...
    NRD_OUTPUT_TEXTURE( RWTexture2D<uint2>, gOut_ViewZ_Normal_Roughness_AccumSpeeds, u, 1 ) \
    EXTRA_OUTPUTS
