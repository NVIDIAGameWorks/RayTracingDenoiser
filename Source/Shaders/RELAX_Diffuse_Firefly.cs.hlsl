...
#include "NRD.hlsli"
#include "STL.hlsli"
#include "RELAX_Diffuse_Firefly.resources.hlsli"
...
void runRCRS(int2 dispatchThreadId, int2 groupThreadId, float3 centerNormal, float centerViewZ, out float4 outDiffuse)
{
