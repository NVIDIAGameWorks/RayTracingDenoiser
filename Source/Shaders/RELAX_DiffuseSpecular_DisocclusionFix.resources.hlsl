...
#define NRD_DECLARE_INPUT_TEXTURES \
    ...
    NRD_INPUT_TEXTURE( Texture2D<uint2>, gSpecularAndDiffuseIlluminationResponsiveLogLuv, t, 1 ) \
    NRD_INPUT_TEXTURE( Texture2D<float2>, gSpecularAndDiffuse2ndMoments, t, 2 ) \
    NRD_INPUT_TEXTURE( Texture2D<float2>, gSpecularAndDiffuseHistoryLength, t, 3 ) \
