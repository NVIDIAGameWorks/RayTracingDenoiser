...
#define RELAX_NORMAL_BANDING_FIX                       STL::Math::DegToRad( 0.625 ) // mitigate banding introduced by normals stored in RGB8 format // TODO: move to CommonSettings?
...
#define RELAX_NORMAL_ROUGHNESS_BITS                    11, 11, 10
