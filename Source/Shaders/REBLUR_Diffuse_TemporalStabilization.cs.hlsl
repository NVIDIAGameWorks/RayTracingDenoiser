...
#include "NRD.hlsl"
#include "STL.hlsl"
#include "REBLUR_Diffuse_TemporalStabilization.resources.hlsl"
...
NRD_EXPORT void NRD_CS_MAIN( int2 threadId : SV_GroupThreadId, int2 pixelPos : SV_DispatchThreadId, uint threadIndex : SV_GroupIndex )
{
    ...
    // Antilag
    float diffAntilag = ComputeAntilagScale( diffInternalData.y, diffHistory, diffM1, diffSigma, diffTemporalAccumulationParams, gDiffMaxFastAccumulatedFrameNum, gAntilag1, gAntilag2 );
