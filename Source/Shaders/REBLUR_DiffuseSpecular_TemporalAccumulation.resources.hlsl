...
#define NRD_DECLARE_INPUT_TEXTURES \
    ...
    NRD_INPUT_TEXTURE( Texture2D<float4>, gIn_HistoryFast_Spec, t, 7 ) \
    NRD_INPUT_TEXTURE( Texture2D<float4>, gIn_Diff, t, 8) \
    NRD_INPUT_TEXTURE( Texture2D<float4>, gIn_Spec, t, 9)
...
#define NRD_DECLARE_OUTPUT_TEXTURES \
    ...
    NRD_OUTPUT_TEXTURE( RWTexture2D<float4>, gOut_Fast_Spec, u, 5 )
