...
size_t nrd::DenoiserImpl::AddMethod_ReblurSpecular(uint16_t w, uint16_t h)
{
    ...
    PushPass("Temporal accumulation");
    {
        ...
        AddDispatch( REBLUR_Specular_TemporalAccumulation, SumConstants(4, 2, 1, 3), 8, 1 );
    }
    ...
    PushPass("Temporal accumulation"); // with confidence
    {
        ...
        AddDispatch( REBLUR_Specular_TemporalAccumulationWithConfidence, SumConstants(4, 2, 1, 3), 8, 1 );
    }
