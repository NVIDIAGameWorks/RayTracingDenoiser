...
size_t DenoiserImpl::AddMethod_RelaxSpecular(uint16_t w, uint16_t h)
{
    enum class Permanent
    {
        SPEC_ILLUM_LOGLUV_CURR = PERMANENT_POOL_START,
        SPEC_ILLUM_RESPONSIVE_LOGLUV_CURR,
        SPEC_ILLUM_RESPONSIVE_LOGLUV_PREV,
        SPEC_MOMENTS_CURR,
        SPEC_MOMENTS_PREV,
        SPEC_ILLUM_UNPACKED,
    ...
    PushPass("Reproject");
    {
        ...
        PushInput( AsUint(Permanent::SPEC_ILLUM_RESPONSIVE_LOGLUV_PREV) );
        PushInput( AsUint(Permanent::SPEC_ILLUM_UNPACKED) );
        PushInput( AsUint(Permanent::SPEC_MOMENTS_PREV) );
        ...
        PushOutput( AsUint(Permanent::SPEC_ILLUM_LOGLUV_CURR) );
        PushOutput( AsUint(Permanent::SPEC_ILLUM_RESPONSIVE_LOGLUV_CURR) );
        PushOutput( AsUint(Permanent::SPEC_MOMENTS_CURR) );
        ...
        AddDispatch( RELAX_Specular_Reproject, SumConstants(2, 7, 6, 14), 8, 1 );
    }

    PushPass("Disocclusion fix");
    {
        PushInput( AsUint(Permanent::SPEC_ILLUM_LOGLUV_CURR) );
        PushInput( AsUint(Permanent::SPEC_ILLUM_RESPONSIVE_LOGLUV_CURR) );
        PushInput( AsUint(Permanent::SPEC_MOMENTS_CURR) );
        PushInput( AsUint(Permanent::SPEC_HISTORY_LENGTH_CURR) );
        PushInput( AsUint(Permanent::NORMAL_ROUGHNESS_DEPTH_CURR), 0, 1, AsUint(Permanent::NORMAL_ROUGHNESS_DEPTH_PREV) );

        PushOutput( AsUint(Transient::SPEC_ILLUM_LOGLUV_PREV) );
        PushOutput( AsUint(Permanent::SPEC_ILLUM_RESPONSIVE_LOGLUV_PREV) );
        PushOutput( AsUint(Permanent::SPEC_MOMENTS_PREV) );

        AddDispatch( RELAX_Specular_DisocclusionFix, SumConstants(0, 3, 2, 5), 8, 1 );
    }

    PushPass("History clamping");
    {
        PushInput( AsUint(Transient::SPEC_ILLUM_LOGLUV_PREV) );
        PushInput( AsUint(Permanent::SPEC_ILLUM_RESPONSIVE_LOGLUV_PREV) );
        PushInput( AsUint(Permanent::SPEC_HISTORY_LENGTH_CURR) );
        ...
        AddDispatch( RELAX_Specular_HistoryClamping, SumConstants(0, 0, 1, 3), 16, 1 );
    }

    PushPass("Firefly suppression");
    {
        PushInput( AsUint(Permanent::SPEC_ILLUM_LOGLUV_CURR) );
        PushInput( AsUint(Permanent::NORMAL_ROUGHNESS_DEPTH_CURR), 0, 1, AsUint(Permanent::NORMAL_ROUGHNESS_DEPTH_PREV) );
        ...
        AddDispatch( RELAX_Specular_Firefly, SumConstants(0, 0, 1, 2), 16, 1 );
    }
    ...
    PushPass("Spatial variance estimation");
    {
        ...
        AddDispatch( RELAX_Specular_SpatialVarianceEstimation, SumConstants(0, 0, 1, 3), 16, 1 );
    }
    ...
    PushPass("A-trous (SMEM)");
    {
        ...
        AddDispatch( RELAX_Specular_ATrousShmem, SumConstants(0, 3, 2, 13), 8, 1 );
    }
    ...
    PushPass("A-trous");
    {
        ...
        AddDispatchRepeated( RELAX_Specular_ATrousStandard, SumConstants(0, 3, 2, 13), 8, 1, halfMaxPassNum );
    }
    ...
    PushPass("A-trous");
    {
        ...
        AddDispatch( RELAX_Specular_ATrousStandard, SumConstants(0, 3, 2, 13), 8, 1 );
    }
    ...
    PushPass("Split screen");
    {
        ...
        AddDispatch( RELAX_Specular_SplitScreen, SumConstants(0, 0, 2, 3), 16, 1 );
    }
...
void DenoiserImpl::UpdateMethod_RelaxSpecular(const MethodData& methodData)
{
    enum class Dispatch
    {
        PACK_INPUT_DATA,
