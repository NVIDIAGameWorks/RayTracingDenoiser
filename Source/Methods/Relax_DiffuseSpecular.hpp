...
size_t DenoiserImpl::AddMethod_RelaxDiffuseSpecular(uint16_t w, uint16_t h)
{
    ...
    PushPass("Reproject");
    {
        ...
        AddDispatch( RELAX_DiffuseSpecular_Reproject, SumConstants(2, 7, 6, 17), 8, 1 );
    }
    ...
    PushPass("History clamping");
    {
        ...
        AddDispatch( RELAX_DiffuseSpecular_HistoryClamping, SumConstants(0, 0, 1, 5), 16, 1 );
    }
    ...
    PushPass("Firefly suppression");
    {
        ...
        AddDispatch( RELAX_DiffuseSpecular_Firefly, SumConstants(0, 0, 1, 2), 16, 1 );
    }
