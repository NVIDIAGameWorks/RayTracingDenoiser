...
size_t nrd::DenoiserImpl::AddMethod_SigmaShadowTranslucency(uint16_t w, uint16_t h)
{
    ...
    PushPass("Blur");
    {
        ...
        AddDispatch( SIGMA_ShadowTranslucency_PrePass, SIGMA_BLUR_SET_CONSTANTS, 16, USE_MAX_DIMS );
    }
    ...
    PushPass("Post-blur");
    {
        ...
        AddDispatch( SIGMA_ShadowTranslucency_Blur, SIGMA_BLUR_SET_CONSTANTS, 16, 1 );
    }
